...
const features = [
  {
    ...
    description:
      "Рассмотрите как развивалась криптография в 20 веке и узнаете на каких идеях строится современное шифрование.",
  },
  {
    icon: Lock,
    title: "Методы шифрования",
    description:
      "Познакомьтесь с различными методами шифрования, использовавшимися в первой половине 20 века.",
  },
  {
    icon: Cpu,
    title: "Принципы работы алгоритмов",
    description:
      "Разберитесь в принципах работы криптографических алгоритмов. Узнаете, как происходит шифрование и расшифрование сообщений.",
  },
  {
    icon: Binary,
