...
const pageData = {
  ...
  description: [
    ...
    "Исторически шифр использовался для защиты дипломатической переписки между Москвой и Вашингтоном во время Холодной войны (так называемая «горячая линия»). Главный недостаток — сложность безопасного распределения ключей, равных по длине сообщениям.",
  ],
  principles: [
    {
