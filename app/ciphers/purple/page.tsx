...
const pageData = {
  ...
  description: [
    "PURPLE (официальное название Type B) — японская шифровальная машина, использовавшаяся для защиты дипломатической переписки с 1939 года. Название «PURPLE» (фиолетовый) дали американские криптоаналитики, присваивавшие цветовые коды японским шифрам.",
    "В отличие от немецкой Энигмы, PURPLE использовала шаговые переключатели (stepping switches) телефонного типа вместо механических роторов. Алфавит разделялся на две группы: шесть гласных («шестёрка») и двадцать согласных («двадцатка»), каждая шифровалась отдельно.",
    "Машина была взломана американской группой криптоаналитиков SIS под руководством Уильяма Фридмана в 1940 году. Лео Розен догадался о конструкции переключателей, что позволило построить копию машины, не имея оригинала.",
  ],
  principles: [
    {
